...
/* toem_history.c */
char *n_get_history_file(memb_t *info);
int n_write_history(memb_t *info);
int n_read_history(memb_t *info);
int n_build_history_list(memb_t *info, char *buf, int linecount);
int n_renumber_history(memb_t *info);
